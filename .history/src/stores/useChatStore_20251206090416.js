...
export const useChatStore = create(persist((set, get) => ({
  ...
  selectUser: async (user) => {
      ...
      try {
          // Call the RPC function we just created to get/create the room safely on the server
          ...
          if (roomId) {
              ...
              // We will let the effect in Chat.jsx fetch messages when roomId changes
          }
      } catch (err) {
