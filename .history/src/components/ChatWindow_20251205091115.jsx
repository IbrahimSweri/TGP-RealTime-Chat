...
function ChatWindow({
    ...
    // Ref for Virtuoso to control scrolling if needed
    ...
    // 2. Define the render function for a single message row
    const renderMessageRow = (index, message) => {
        ...
        return (
            <div
                // Note: key is handled by Virtuoso, but we keep className structure
        ...
        <div className="h-full flex flex-col">
            ...
            >
                ...
                <ChatContainer style={{ background: 'transparent', height: '100%' }}>
                    {/* 3. Update MessageList to disable its own scroll and allow Virtuoso to take over */}
                    <MessageList 
                        style={{ 
                            background: 'transparent', 
                            height: '100%', 
                            overflow: 'hidden', // Disable Chatscope's native scroll
                            display: 'flex', 
                    ...
                    >
                        {isLoadingMessages ? (
                            ...
                            <Virtuoso
                                ...
                                // "auto" makes it stick to the bottom when new messages arrive
                                followOutput="auto"
                                
                                // Optional: Start at bottom if you have history
